//Program to Show RELATION CLASS. 
...
bool RELATION::transitive()
{
	...
	if(flag != true)
		cout << "\nRelation R is NOT TRANSITIVE."<<endl<<endl;
	
	else
		cout << "\nRelation R is TRANSITIVE."<<endl<<endl;
	
	return flag;
}

void RELATION::equvivalence()
{
	cout<<"For EQUVIVALENCE Relation : "<<endl;
	
	if(reflexive() == 0 && symmetric() == 0 && transitive())
	{
		cout<<"\nRelation R is EQUIVALENCE."<<endl<<endl;	
	}
	else
	{
		cout<<"\nRelation R is NOT EQUIVALENCE."<<endl<<endl;
    }
}

void RELATION::partialorder()
{
	cout<<"For PARTIAL-ORDER Relation : "<<endl;
		if(reflexive() == 0 && antiSymmetric() && transitive())
	{
		cout<<"\nRelation R is PARTIAL-ORDER.";
	}
	else
	{
		cout<<"\nRelation R is NOT PARTIAL-ORDER.";
	}
}
